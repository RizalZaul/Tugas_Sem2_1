...
public class PERSEGI_PANJANG extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tf_Panjang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tf_PanjangKeyTyped(evt);
            }
        });

        jLabel3.setText("LEBAR");

        tf_Lebar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tf_LebarKeyTyped(evt);
            }
        });
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(tf_Panjang)
                                            .addComponent(tf_Lebar, javax.swing.GroupLayout.DEFAULT_SIZE, 178, Short.MAX_VALUE)
    ...
    private void bt_HitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_HitungActionPerformed
        panjang = Double.parseDouble(tf_Panjang.getText());
        lebar = Double.parseDouble(tf_Lebar.getText());
        luas = panjang * lebar;
    ...
    private void tf_PanjangKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_PanjangKeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }
    }//GEN-LAST:event_tf_PanjangKeyTyped

    private void tf_LebarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tf_LebarKeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }
    }//GEN-LAST:event_tf_LebarKeyTyped
